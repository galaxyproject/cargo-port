...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="static/clipboard.min.js"
            integrity="sha512-FinFzj/6iY5TVAeVSWdllRYbtz7Kl1t2pq9Oy5ku7coxGEhIxwTG6Kxsbvx8C5btRKsA7zst3mphN01MBYsLgg=="
            crossorigin="anonymous"></script>
    ...
    <body>
        <div id="main" class="container">
            ...
            <!--p>
                ...
                <pre>curl --silent https://raw.githubusercontent.com/galaxyproject/cargo-port/master/bin/gsl.py | python - --package_id augustus_3_1</pre>
            </p-->
...
<div class="row">
    <div class="col-xs-10"><pre id="code">&lt;action type="download_by_url" sha256sum="${sha}"&gt;
    https://depot.galaxyproject.org/software/${url}
&lt;/action&gt;</pre></div><div class="col-xs-2"><button type="button" id="copy-button" class="btn" style="width:100%;height:100%" data-clipboard-target="#code">Copy<br/><span class="glyphicon glyphicon-copy" aria-hidden="true"></span></button>
    </div>
</div>
<h3>Bash Usage</h3><div class="row"><div class="col-xs-12" style="overflow-x:hidden"><table class="table table-striped">
            <tr><td>SHA256</td><td>${sha}</td></tr>
            <tr><td>URL</td><td>https://depot.galaxyproject.org/software/${url}</td></tr>
        </table></div></div>
`
                });
            }
